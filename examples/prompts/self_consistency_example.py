...
Description: Prompt encourages answering in multiple ways to confirm consistency.
"""
...
example_yaml = """agent_scratchpad: 'Try different ways: 13 + 24 = 37, or break into 10+3 and 20+4.'
expected_output:
  contains: '37'
input: What is 13 + 24?
memory_context: ''
...
async def main():
    ...
    print("[bold yellow]▶ Running example:[/] self_consistency")
