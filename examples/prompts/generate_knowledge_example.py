"""
Example: Generate Knowledge
Description: Asks the agent to create new fictional content.
"""
...
expected_output:
  contains: creature
input: Invent a mythological creature and describe it.
memory_context: ''
step_count: 0
tool_names: []
tool_used: None
...
async def main():
    ...
    print("[bold yellow]▶ Running example:[/] generate_knowledge")
