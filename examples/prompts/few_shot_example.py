"""
Example: Few Shot
Description: Use prior example to guide answer format.
"""
...
example_yaml = """agent_scratchpad: 'Example: Translate ''dog'' to Spanish. -> perro'
expected_output:
  contains: gato
...
async def main():
    ...
    print("[bold yellow]▶ Running example:[/] few_shot")
