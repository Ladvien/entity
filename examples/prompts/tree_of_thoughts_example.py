...
Description: Compares multiple branches of reasoning before decision.
"""
...
example_yaml = """agent_scratchpad: 'Option 1: New York has... Option 2: SF has...'
expected_output:
  contains: depends
input: Should I move to New York or San Francisco for tech jobs?
memory_context: ''
step_count: 0
tool_names: []
tool_used: None
...
async def main():
    ...
    print("[bold yellow]▶ Running example:[/] tree_of_thoughts")
