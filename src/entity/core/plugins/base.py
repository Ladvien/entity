...
def AutoGeneratedPlugin(
    *, func: Any, stages: list[PipelineStage], name: str, base_class: Type[BasePlugin]
) -> BasePlugin:
    """Generate a plugin class dynamically."""

    class GeneratedPlugin(base_class):
        async def _execute_impl(self, context: Any) -> Any:
            return await func(context)

    GeneratedPlugin.stages = stages
    GeneratedPlugin.name = name
