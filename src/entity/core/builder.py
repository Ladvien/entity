...
from .plugins import AdapterPlugin, AutoGeneratedPlugin
from .plugins import BasePlugin as BasePluginType
from .plugins import PromptPlugin
from .registries import (PluginRegistry, ResourceContainer, SystemRegistries,
                         ToolRegistry)
from .runtime import AgentRuntime

BasePluginInterface = BasePluginType
PluginAutoClassifier = plugin_utils.PluginAutoClassifier
BasePlugin = BasePluginType
