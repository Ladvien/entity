...
from .plugins import BasePlugin, AutoGeneratedPlugin
...
async def execute_stage(stage: PipelineStage, state: PipelineState, registries: SystemRegistries) -> None:
    ...
    for plugin in stage_plugins:
        context_cls = SimpleContext if isinstance(plugin, AutoGeneratedPlugin) else PluginContext
...
async def execute_pending_tools(state: PipelineState, registries: SystemRegistries) -> None:
